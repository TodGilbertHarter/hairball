...
import com.giantelectronicbrain.catfood.buckets.AsyncBucketDriverTest;
 ...
 *
 */
public class AsyncFsBucketDriverTest extends AsyncBucketDriverTest {

	@Override
	protected IBucketDriver createUUT(Vertx vertx) throws BucketDriverException {
		return FsBucketTestUtils.createUUT(vertx);
	}
